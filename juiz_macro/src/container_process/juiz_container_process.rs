...
use crate::{container, proc_macro::TokenStream};
use syn::{parse_macro_input, ItemFn, Stmt};

use crate::util::parse_attr;
use super::container_process_manifest::{construct_manif_tokenstream, manifest_tokenstream};
...
pub(crate) fn juiz_container_process_inner(attr: TokenStream, item: TokenStream) -> TokenStream {
    ...
    let return_manifest = construct_manif_tokenstream(container_type_ident, function_name, &manifest_attr, &arg_map);
